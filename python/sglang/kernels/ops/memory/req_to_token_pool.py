...
class GatherReqToTokenPool:
    ...
    def triton(
        ...
        *,
        ...
        _gather_req_to_token_pool_kernel[(batch_size,)](
            req_pool_indices,
            req_to_token,
            start_offset,
            end_offset,
...
class ScatterReqToTokenPool:
    ...
    def triton(
        ...
        *,
        ...
        _scatter_req_to_token_pool_kernel[(batch_size,)](
            req_pool_indices,
            req_to_token,
            start_offset,
            end_offset,
...
@triton.jit
def _scatter_req_to_token_pool_kernel(
    req_pool_indices,
    req_to_token,
    start_offset,
    end_offset,
