...
from sglang.srt.speculative.spec_utils import ScatterReqToTokenPool
    ...
    def forward_batch_generation(
        ...
        if self._use_triton_prepare_block:
            try:
                ...
                verify_out_cache_loc = GatherReqToTokenPool.execute_equal_length(
